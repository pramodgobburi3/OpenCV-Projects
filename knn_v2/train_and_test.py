...
def main():
    ...
    try:
        ...
        print("error, unable to open classifications.txt, exiting the program\n\n")
        os.system("pause")
        return
    ...
    try:
        ...
        print("error, unable to open flattened_images.txt", np.float32)
        os.system("pause")
        return
    ...
    imgTestingNumbers = cv2.imread("test_imgs/test2.png")
    ...
    contours_img = cv2.drawContours(imgThreshCopy, npaContours, -1, (255, 0, 0), 3)
